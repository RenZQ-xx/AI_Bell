...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the Geometric-DiffUCO experiment for the 4-2-2 Bell polytope.")
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("src/experiments/422/DIffUCO/outputs"),
...
def main() -> None:
    ...
    energy_config = EnergyConfig(
        min_cardinality=int(points.shape[1]),
